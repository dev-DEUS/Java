public class Hangman {
	...
	private String[] words = { "Schifffahrt", "Klassenfahrt", "Pseudozufallszahlengenerator", "Konzertkarten",
			"Schauspieler", "Generalvollmacht", "Passagier" };
	...
	public void play() {
		...
		StringBuffer geraten = new StringBuffer(this.geraten);
		String buchstabe = "";
		...
		while (alive) {
			...
			this.geraten = geraten.toString();

			if (geheim.equals(geraten.toString())) {
