...
*/
     ...
     * ColoredShape coloredArrow = new ColoredShape(arrowShape, Color.WHITE,
     * Color.WHITE, 15.0f);
     * 
     ...
     * 
     * translateY += translateYIncrement; // Aktualisierung der gesamten
     * Verschiebung
     * shapeArr[i].translate(100, translateY); // Anwednung der Verschiebung und
     * Startpunkt auf x = 100
     * 
     * totalRotation += rotationIncrement; // Aktualisierung der gesamten
     * Verschiebung
     * 
