...
public class RegPatternMatcher {
    ...
    public static void findAdverbs(String text) {
        int count = 0;
        Pattern p = Pattern.compile("[a-zA-Z]+ly\\b");
    ...
    public static void findRecipesWithoutChocolate(String recipes) {
        Pattern p = Pattern.compile("Cake \\d:(?!.*chocolate).*");
        Matcher m = p.matcher(recipes);
    ...
    public static void main(String[] args) {
        ...
        String recipeList = "Cake 1: sugar, flour, cocoa powder, baking powder, baking soda, salt, eggs, milk, vegetable oil, vanilla extract, chocolate chips \n"
                +
